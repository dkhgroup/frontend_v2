...
export async function getStaticProps() {
    const res = await fetch(`${globalConfig.api_url}/static-pages/?filters[slug][$eq]=chinh-sach-bao-mat&populate[0]=thumbnail&populate[1]=seo&populate[2]=seo.thumbnail&populate[3]=blog_category`)
